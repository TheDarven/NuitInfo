...
<div class="chat">
	<?php foreach ($messages as $message) { ?>
		<div class="bubble <?= $message->getIdAuteur() == $connected ? 'me' : 'you' ?>">
			<?= $message->getContenu() ?>
		</div>
	<?php } ?>
</div>
...
<div>
	<form method="POST">	
        ...
        <input type="hidden" name="idConversation" value="<?= $params['id']?>">
		<input type="hidden" name="connectedId" value="<?= $connected ?>">
